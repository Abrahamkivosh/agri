				...
				<?php
					...
					<?php
						...
						while($row = $result->fetch_array()):
							...
							// $picDestination = "./AgroCulture/images/productImages/".$row['pimage'];
						...
						?>
							...
							<img class="image fit" src="<?php echo $picDestination;?>" height="220px;"  /></a>
							...
							<form action="./AddToCart.php" method="POST" >
								...
								<input type="hidden" name="url" value="<?php echo explode("/", $_SERVER['REQUEST_URI'])[2] ?> " >
