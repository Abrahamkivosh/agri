...
<footer class="footer-distributed" style="background-color:black" id="aboutUs">
	...
	<div class="footer-left">
		<h3 style="font-family: 'Times New Roman', cursive;">JKUAT FARM &copy; </h3>
		<!--	<div class="logo">
	...
	<div class="footer-center">
		<div>
			...
			<p style="font-size:20px">JKUAT FARM<span>JUJA</span></p>
		</div>
		<div>
		...
		<div>
			...
			<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">dvc@rpe.jkuat.ac.ke</a></p>
		</div>
	</div>
	...
	<form class="modal-content animate" action="Login/login.php" method='POST'>
		...
		<div class="container">
			...
			<div class="row uniform">
				...
				<div class="2u 12u$(small)">
					<input type="radio" id="driver" name="category" value="0">
			...
			<section>
				<h3>SignUp</h3>
					<center>
						...
						<div class="row uniform">
							<div class="6u 12u$(xsmall)">
								<input type="text" name="addr" id="addr" value="" placeholder="Location" style="width:80%" required />
							</div>
						</div>
						<div class="row uniform">
							<p>
							...
							<div class="2u 12u$(small)">
								<input type="radio" id="farmer1" name="category" value="1">
								<label for="farmer1">Admin</label>
							</div>
							<div class="2u 12u$(small)">
							...
							<div class="2u 12u$(small)">
								<input type="radio" id="driver1" name="category" value="2">
