...
<body id="reportsPage">
    <div class="" id="home">
            ...
            <div class="container h-100">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto h-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="uploadProduct.php">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link d-block" href="./Login/logout.php">
                                <?php $_SESSION['Name']   ?> Admin  , <b>Logout</b>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <p class="text-white mt-5 mb-5">Welcome back, <b>  <?php  $_SESSION['Name']   ?></b></p>
                </div>
            </div>
            <!-- row -->
            <div class="row tm-content-row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 tm-block-col">
                    <div class="tm-bg-primary-dark tm-block tm-block-taller">
                        <h2 class="tm-block-title">Profit Analysis</h2>
